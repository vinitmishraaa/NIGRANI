...
// Browsers served from a plain LAN HTTP address can expose crypto.subtle as
// unavailable. Use Web Crypto when available and fall back to a small pure-JS
// SHA-256 implementation so fingerprinting still works on a phone demo.
